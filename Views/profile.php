        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="notifivation.php" class="nav-link"><img src="../Views/img/icon-notification.svg" alt="" c></a></li>
                    ...
                    <li class="nav-item my-icon"><img src="../Views/img_uploaded/user/sample-person.jpg" class="js-popover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" 
                    ...
                    <?php if (isset($_GET['user_id'])) : ?>
                     ...
                     <?php else: ?>
                        ...
                        <button class="btn btn-reverse btn-sm" data-bs-toggle="modal" data-bs-target="#js-modal">プロフィール編集</button>
                                                            <!--プロフィール編集ボタンに↑0bootsttrapのdata属性を持たせ、クッリクした時に、targetのmodalが表示される -->
                    <?php endif; ?>
                    <div class="modal fade" id="js-modal" tabindex="-1" aria-hidden="true">
                    <!--tabindex="-1":タブ操作の対象から外す,aria-hidden=true:読み上げ機能から無視-->
