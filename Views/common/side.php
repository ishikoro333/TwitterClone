<div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="notification.php" class="nav-link"><img src="<?php echo HOME_URL; ?>Views/img/icon-notification.svg" alt="" c></a></li>
                    ...
                    <li class="nav-item my-icon"><img src="<?php echo htmlspecialchars($view_user['image_path']); ?>" alt="" class="js-popover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" 
